Ext.define('activos_scsj.view.opciones.UsuarioPrivilegio.Lista', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.opciones.usuarioprivilegio.lista',
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('opciones.usuarioprivilegio.add'),
                            itemId: 'add',
                            iconCls: 'icon_add',
                            text: 'Añadir'
                        },
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('opciones.usuarioprivilegio.edit'),
                            itemId: 'edit',
                            iconCls: 'icon_edit',
                            text: 'Editar'
                        },
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('opciones.usuarioprivilegio.delete'),
                            itemId: 'delete',
                            iconCls: 'icon_delete',
                            text: 'Eliminar'
                        }
