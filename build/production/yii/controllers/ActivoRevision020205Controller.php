 ...
 */
class ActivoRevision020205Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ActivoRevision020205.create',
				'index'=>'application.controllers.ActivoRevision020205.read',
				'update'=>'application.controllers.ActivoRevision020205.update',
				'delete'=>'application.controllers.ActivoRevision020205.delete',
		);
	}
}
