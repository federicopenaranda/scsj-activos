<?php
/**
 * Este es el controlador para el modelo "Departamento010004".
 */
class Departamento010004Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Departamento010004.create',
				'index'=>'application.controllers.Departamento010004.read',
				'update'=>'application.controllers.Departamento010004.update',
				'delete'=>'application.controllers.Departamento010004.delete',
		);
	}
}
