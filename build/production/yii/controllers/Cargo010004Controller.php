<?php
/**
 * Este es el controlador para el modelo "Cargo010004".
 */
class Cargo010004Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Cargo010004.create',
				'index'=>'application.controllers.Cargo010004.read',
				'update'=>'application.controllers.Cargo010004.update',
				'delete'=>'application.controllers.Cargo010004.delete',
		);
	}
}
