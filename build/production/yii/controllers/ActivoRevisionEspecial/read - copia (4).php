			...
			if (json_last_error() === JSON_ERROR_NONE) {
				$model=new ActivoRevision020205();
				 try {
					...
					$modelo =$model::model()->with('fkIdActivo','fkIdActivoEstado','fkIdRevision','activoUbicacions')->together()->findAll(array("condition"=>$condition));
					$model2 = new Activo020101();
					$modelo2=$model2::model()->with('fkIdActivoUtilitario','fkIdArea','fkIdDepartamento','fkIdUnidad','fkIdActivoClasificacion','fkIdProveedor','activoUbicacions','activoRevisions')->together()->findAll(array("condition"=>$condition));
					...
					foreach ($modelo2 as $staff2):
						...
						if ( $staff2->id_activo == $va->fk_id_activo) {
							...
							#echo $va->activoUbicacions->estado_activo_ubicacio;
							$aux2=array();
							#print_r($va->activoUbicacions);
