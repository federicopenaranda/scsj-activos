<?php
/**
 * Este es el controlador para el modelo "UsuarioPrivilegio000004".
 */
class UsuarioPrivilegio000004Controller extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.UsuarioPrivilegio000004.create',
				'index'=>'application.controllers.UsuarioPrivilegio000004.read',
				'update'=>'application.controllers.UsuarioPrivilegio000004.update',
				'delete'=>'application.controllers.UsuarioPrivilegio000004.delete',
		);
	}
}
