<?php
/**
 * Este es el controlador para el modelo "UsuarioTipo000201".
 */
class UsuarioTipo000201Controller extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.UsuarioTipo000201.create',
				'index'=>'application.controllers.UsuarioTipo000201.read',
				'update'=>'application.controllers.UsuarioTipo000201.update',
				'delete'=>'application.controllers.UsuarioTipo000201.delete',
		);
	}
}
