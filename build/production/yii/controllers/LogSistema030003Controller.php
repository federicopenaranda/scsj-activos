<?php
/**
 * Este es el controlador para el modelo "LogSistema030003".
 */
class LogSistema030003Controller extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.LogSistema030003.create',
				'index'=>'application.controllers.LogSistema030003.read',
				'update'=>'application.controllers.LogSistema030003.update',
				'delete'=>'application.controllers.LogSistema030003.delete',
		);
	}
}
