        ...
        if ($error == "") {
            ...
            try {
				...
				foreach($modelo as $staff) {
                	$aux=array();
					$aux['id_activo_estado']=$staff->id_activo_estado;
					$aux['nombre_activo_estado']=$staff->nombre_activo_estado;
					$aux['descripcion_activo_estado']=$staff->descripcion_activo_estado;
					$arreglo[]=$aux;
				}
			} catch(Exception $e) {
				$error=$e->getMessage();
