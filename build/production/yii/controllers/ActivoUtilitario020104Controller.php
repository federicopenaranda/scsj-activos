<?php
/**
 * Este es el controlador para el modelo "ActivoUtilitario020104".
 */
class ActivoUtilitario020104Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ActivoUtilitario020104.create',
				'index'=>'application.controllers.ActivoUtilitario020104.read',
				'update'=>'application.controllers.ActivoUtilitario020104.update',
				'delete'=>'application.controllers.ActivoUtilitario020104.delete',
		);
	}
}
