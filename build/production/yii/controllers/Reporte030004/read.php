        ...
        if ($error == "") {
            ...
            try {
				...
				foreach($modelo as $staff) {
                	$aux=array();
					$aux['id_reporte']=$staff->id_reporte;
					$aux['codigo_reporte']=$staff->codigo_reporte;
					$aux['nombre_reporte']=$staff->nombre_reporte;
					$aux['descripcion_reporte']=$staff->descripcion_reporte;
					$aux['estado_reporte']=$staff->estado_reporte;
					$aux['ruta_reporte']=$staff->ruta_reporte;
					$aux['tipo_reporte']=$staff->tipo_reporte;
					$arreglo[]=$aux;
				}
			} catch(Exception $e) {
				$error=$e->getMessage();
