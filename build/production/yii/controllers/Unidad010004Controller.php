<?php
/**
 * Este es el controlador para el modelo "Unidad010004".
 */
class Unidad010004Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Unidad010004.create',
				'index'=>'application.controllers.Unidad010004.read',
				'update'=>'application.controllers.Unidad010004.update',
				'delete'=>'application.controllers.Unidad010004.delete',
		);
	}
}
