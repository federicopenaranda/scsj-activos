        ...
        if ($error == "") {
            ...
            try {
				...
				foreach($modelo as $staff) {
                	$aux=array();
					$aux['id_revision']=$staff->id_revision;
					$aux['fecha_inicio_revision']=$staff->fecha_inicio_revision;
					$aux['fecha_fin_revision']=$staff->fecha_fin_revision;
					$aux['observaciones_revision']=$staff->observaciones_revision;
					$aux['descripcion_revision']=$staff->descripcion_revision;
					$aux['estado_revision']=$staff->estado_revision;
					$arreglo[]=$aux;
				}
			} catch(Exception $e) {
				$error=$e->getMessage();
