<?php
/**
 * Este es el controlador para el modelo "UsuarioUnidad000102".
 */
class UsuarioUnidad000102Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.UsuarioUnidad000102.create',
				'index'=>'application.controllers.UsuarioUnidad000102.read',
				'update'=>'application.controllers.UsuarioUnidad000102.update',
				'delete'=>'application.controllers.UsuarioUnidad000102.delete',
		);
	}
}
