		                                        	...
		                                        	foreach ($valor as $subvalue) {
														...
														switch ($NomTabRel) {
															case 'usuario_tipo_usuario_00_01_02':
																$whosloggedin=UsuarioTipoUsuario000102::model()->find('fk_id_usuario=:fk_id_usuario',array(':fk_id_usuario'=>$record['id_usuario'])); 
$whosloggedin->delete();
																break;
															case 'usuario_unidad_00_01_02':
																 $whosloggedin=UsuarioUnidad000102::model()->find('fk_id_usuario=:fk_id_usuario',array(':fk_id_usuario'=>$record['id_usuario'])); 
$whosloggedin->delete();
																break;
														}
														if ($obj!==null) {
