<?php
/**
 * Este es el controlador para el modelo "ActivoProveedor020104".
 */
class ActivoProveedor020104Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ActivoProveedor020104.create',
				'index'=>'application.controllers.ActivoProveedor020104.read',
				'update'=>'application.controllers.ActivoProveedor020104.update',
				'delete'=>'application.controllers.ActivoProveedor020104.delete',
		);
	}
}
