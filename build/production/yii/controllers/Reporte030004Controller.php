<?php
/**
 * Este es el controlador para el modelo "Reporte030004".
 */
class Reporte030004Controller extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Reporte030004.create',
				'index'=>'application.controllers.Reporte030004.read',
				'update'=>'application.controllers.Reporte030004.update',
				'delete'=>'application.controllers.Reporte030004.delete',
		);
	}
}
