<?php
/**
 * Este es el controlador para el modelo "ActivoClasificacion020104".
 */
class ActivoClasificacion020104Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ActivoClasificacion020104.create',
				'index'=>'application.controllers.ActivoClasificacion020104.read',
				'update'=>'application.controllers.ActivoClasificacion020104.update',
				'delete'=>'application.controllers.ActivoClasificacion020104.delete',
		);
	}
}
