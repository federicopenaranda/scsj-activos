<?php
/**
 * Este es el controlador para el modelo "Ubicacion020104".
 */
class Ubicacion020104Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Ubicacion020104.create',
				'index'=>'application.controllers.Ubicacion020104.read',
				'update'=>'application.controllers.Ubicacion020104.update',
				'delete'=>'application.controllers.Ubicacion020104.delete',
		);
	}
}
