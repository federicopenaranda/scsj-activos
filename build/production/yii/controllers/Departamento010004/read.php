        ...
        if ($error == "") {
            ...
            try {
				...
				foreach($modelo as $staff) {
                	$aux=array();
					$aux['id_departamento']=$staff->id_departamento;
					$aux['nombre_departamento']=$staff->nombre_departamento;
					$aux['codigo_departamento']=$staff->codigo_departamento;
					$aux['descripcion_departamento']=$staff->descripcion_departamento;
					$arreglo[]=$aux;
				}
			} catch(Exception $e) {
				$error=$e->getMessage();
