        ...
        if ($error == "") {
            ...
            try {
				...
				foreach($modelo as $staff) {
                	$aux=array();
					$aux['id_unidad']=$staff->id_unidad;
					$aux['nombre_unidad']=$staff->nombre_unidad;
					$aux['codigo_unidad']=$staff->codigo_unidad;
					$aux['descripcion_unidad']=$staff->descripcion_unidad;
					$arreglo[]=$aux;
				}
			} catch(Exception $e) {
				$error=$e->getMessage();
