<?php
/**
 * Este es el controlador para el modelo "ActivoValor020103".
 */
class ActivoValor020103Controller extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ActivoValor020103.create',
				'index'=>'application.controllers.ActivoValor020103.read',
				'update'=>'application.controllers.ActivoValor020103.update',
				'delete'=>'application.controllers.ActivoValor020103.delete',
		);
	}
}
