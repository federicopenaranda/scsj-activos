 ...
 * @property integer $fk_id_activo_estado
 ...
 * @property ActivoEstado020204 $fkIdActivoEstado
...
class ActivoRevision020205 extends CTQ
{
	...
	public function rules()
	{
		...
		return array(
			array('fk_id_revision, fk_id_activo, fk_id_activo_estado, fk_id_usuario, fecha_activo_revision', 'required'),
			array('fk_id_revision, fk_id_activo, fk_id_activo_estado, fk_id_usuario', 'numerical', 'integerOnly'=>true),
			array('observacion_activo_revision, estado_activo_revision', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_activo_revision, fk_id_revision, fk_id_activo, fk_id_activo_estado, fk_id_usuario, fecha_activo_revision, fecha_creacion_activo_revision, observacion_activo_revision, estado_activo_revision', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'fkIdActivoEstado' => array(self::BELONGS_TO, 'ActivoEstado020204', 'fk_id_activo_estado'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'fk_id_activo_estado' => 'Fk Id Activo Estado',
	...
	public function search()
	{
		...
		$criteria->compare('fk_id_activo_estado',$this->fk_id_activo_estado);
