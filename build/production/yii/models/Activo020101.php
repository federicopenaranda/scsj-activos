...
class Activo020101 extends CTQ
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_activo, fk_id_proveedor, fk_id_activo_clasificacion, fk_id_activo_utilitario, fk_id_unidad, fk_id_area, fk_id_departamento, codigo_activo, descripcion_activo, piezas_activo, fecha_adquisicion_activo, precio_adquisicion_activo, garantia_meses_activo, archivo_foto_activo, fecha_creacion_activo', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function getNameFKey() {
    	return array(
				'fk_id_activo_utilitario'=>array('activo_utilitario_02_01_04','id_activo_utilitario'),
				'fk_id_area'=>array('area_01_00_04','id_area'),
				'fk_id_departamento'=>array('departamento_01_00_04','id_departamento'),
				'fk_id_unidad'=>array('unidad_01_00_04','id_unidad'),
				'fk_id_activo_clasificacion'=>array('activo_clasificacion_02_01_04','id_activo_clasificacion'),
				'fk_id_proveedor'=>array('activo_proveedor_02_01_04','id_activo_proveedor'),
		);
    }
