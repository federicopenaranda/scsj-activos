 ...
 *
 * The followings are the available columns in table 'usuario_tipo_usuario_00_01_02':
 * @property integer $fk_id_usuario_tipo
 * @property integer $fk_id_usuario
 */
class UsuarioTipoUsuario000102 extends CTQ
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('fk_id_usuario_tipo, fk_id_usuario', 'required'),
			array('fk_id_usuario_tipo, fk_id_usuario', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('fk_id_usuario_tipo, fk_id_usuario', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UsuarioTipoUsuario000102 the static model class
	 */
