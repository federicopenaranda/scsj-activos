        ...
        <script>
            $( document ).ready(function() {
                $( "#ingresar" ).click(function( event ) {
                    ...
                    $.ajax({
                        //url: "http://200.105.158.70:8080/activos_scsj/yii/index.php/Usuario000100/login?" + data,
                        url: "http://192.168.1.110:8080/activos_scsj/yii/index.php/Usuario000100/login?" + data,
                        jsonp: "callback",
                        dataType: "jsonp",
