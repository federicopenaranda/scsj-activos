...
<html>
    <head>
        ...
        <title>Activos SJ - Ingreso al Sistema</title>
        ...
        <script>
            $( document ).ready(function() {
                $( "#ingresar" ).click(function( event ) {
                    ...
                    $.ajax({
                        //url: "http://200.105.158.70:8080/activos_scsj/yii/index.php/Usuario000101/login?" + data,
                        url: "http://192.168.1.110:8080/activos_scsj/yii/index.php/Usuario000101/login?" + data,
                        //url: "http://190.181.18.240/activos_scsj/yii/index.php/Usuario000101/login?" + data,
                        jsonp: "callback",
                        dataType: "jsonp",
    ...
    <body id="login">
        ...
        <div id="wrapper">
            <div id="content">
                <div id="header">
                    <h1><a href=""><img src="resources/images/logo3.png" alt="Activos SCSJ - Sociedad Católica San José"></a></h1>
                    <span class="title2">Activos SCSJ</span>
                </div>
